...
import de.tuttas.gameserver.PlayGameListener;
...
import de.tuttas.tictactoetournament.GameManagementActivity;
...
public class Game extends GameManagementActivity implements PlayGameListener,GameListener {
	...
	public void updateDisconnect() {
		...
		this.showDialog(getResources().getString(R.string.player_disconnected));
		gc.stats(1, 1, 0);
	...
	public void updatePlay(JSONObject obj) {
		...
		if (obj.optString("command").compareTo("timeout")==0) {
			this.showDialog(getResources().getString(R.string.player_timedout));			
			gc.stats(1, 1, 0);
			gc.addScore(l.getScore());
			
		}
		else if (obj.optString("command").compareTo("close")==0) {
			this.showDialog(getResources().getString(R.string.player_closed));
			gc.stats(1, 1, 0);
			gc.addScore(l.getScore());
		}
	...
	public void setLeftPlayer(Player p) {
		...
		ImageView iv = (ImageView) this.findViewById(R.id.imageViewplayerLeft);
	...
	public void setRightPlayer(Player p) {
		TextView tv = (TextView) this.findViewById(R.id.textViewplayerRight);
		ImageView iv = (ImageView) this.findViewById(R.id.imageViewplayerRight);
		tv.setText(p.getName());
		iv.setImageResource(p.getIcon());
	}
	...
	public void setScore(int score) {
		// TODO Auto-generated method stub
		((TextView) this.findViewById(R.id.textView_score)).setText(Integer.toString(score));
	...
	public void setProgessBar(int left, int right) {
		// TODO Auto-generated method stub
		ProgressBar pbl = (ProgressBar) this.findViewById(R.id.progressBarleft);
		ProgressBar pbr = (ProgressBar) this.findViewById(R.id.ProgressBarright);
