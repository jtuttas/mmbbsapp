...
public class Organisation extends Activity {
	...
	String[] orga_funktion = new String[] {
			...
			"Koordination Medien Vollzeit, Statistik, Vertretungsplanung, Qualit‰tsmanagement, Befragungssysteme"
	};
	Context context;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gallery.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView parent, View v, int position, long id) {
                //Toast.makeText(Organisation.this, "gew‰hlt" + position+" iv="+iv, Toast.LENGTH_SHORT).show();
